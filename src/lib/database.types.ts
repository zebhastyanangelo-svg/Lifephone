  ...
  public: {
    Tables: {
      expansion_leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "expansion_leads_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
      ...
      store_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_orders_store_profile_id_fkey"
    ...
    Functions: {
      ...
      create_admin_user: { Args: { p_email: string; p_password: string; p_full_name: string; p_role?: string }; Returns: Json }
